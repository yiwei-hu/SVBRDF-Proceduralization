...
template <>
struct CudaVec<1, unsigned char> {
    typedef uchar1 type;
};
template <>
struct CudaVec<2, unsigned char> {
    typedef uchar2 type;
};
template <>
struct CudaVec<4, unsigned char> {
    typedef uchar4 type;
};

template <>
struct CudaVec<1, int> {
    typedef int1 type;
};
template <>
struct CudaVec<2, int> {
    typedef int2 type;
};
template <>
struct CudaVec<4, int> {
    typedef int4 type;
};

template <>
struct CudaVec<1, float> {
    typedef float1 type;
};
template <>
struct CudaVec<2, float> {
    typedef float2 type;
};
template <>
struct CudaVec<4, float> {
    typedef float4 type;
};
...
template <>
struct CudaKind<unsigned char> {
    static const cudaChannelFormatKind kind = cudaChannelFormatKindUnsigned;
};
template <>
struct CudaKind<int> {
    static const cudaChannelFormatKind kind = cudaChannelFormatKindSigned;
};
template <>
struct CudaKind<float> {
    static const cudaChannelFormatKind kind = cudaChannelFormatKindFloat;
};
...
template <int N, typename T, int M = N<3 ? N : 4> struct TexArray2 {
    int width;
    int height;
